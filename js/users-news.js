...
$.ajax({
    ...
    success: function(response) {
        if (response.success === true) {
            ...
            console.log('Images appended. Initializing Slick Slider.');

            // Initialize Slick Slider after images are appended and DOM is ready
            ...
            // Additional initialization and event handlers for other sliders (if any)
            $('#slickslider2').slick({
                slidesToShow: 3,
                infinite: true,
                arrows: false,
    ...
    data: {
        ...
        if(response.success === true){
            ...
            for (let d = 0; d < response.data.length; d++) {
                ...
                $('.related-campaign').append(`<a href="${ siteURL }/users/donation-details.html?id=${ donationId }" class="donation-item w-inline-block">
